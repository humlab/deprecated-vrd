...
# %% [markdown]
# # Comparing a Video Against Itself
#
...
# %%
query_video_path = reference_video_path
assert(query_video_path.exists())
print(f'query_video_path={query_video_path}')
assert(query_video_path == reference_video_path)
...
# %% [markdown]
# We observe the resulting keyframes and expect them to be **equal**,
...
# %% [markdown]
# The similarity scores for these segments should all be 1.0. Expect these to be **equal**

# %%
print(f'similarity_scores={similarity_scores}')
assert(all([score == 1.0 for score in similarity_scores]))
