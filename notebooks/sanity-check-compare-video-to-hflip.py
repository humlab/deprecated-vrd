...
# %%
query_video_path = ffmpeg.hflip(reference_video_path, OUTPUT_DIRECTORY)
...
# %% [markdown]
# We observe the resulting keyframes and expect them to be **equal**, yes, equal. We've only applied a horizontal flip!
